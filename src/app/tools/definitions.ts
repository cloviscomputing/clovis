// Public tool input and return-shape definitions. This is the contract input
// used to derive signatures, MCP schemas, registry rows, and ToolSpecs.
import type { ToolDefinition } from "../tool-spec.js";
